...
void W5500_Config(void)
{
  ...
  uint8 lip[4]={192,168,13,202};/*定义lp变量*/
  uint8 sub[4]={255,255,255,0};/*定义subnet变量*/
  uint8 gw[4]={192,168,13,1};/*定义gateway变量*/
  uint8 ip[4];

  WIZ_SPI_Init();/*初始化SPI接口*/ 
  DebugPf("W5500 initialized!\r\n");  
...
{ 
  ...
  Delay_MS(10);
  GPIO_SetBits(GPIOD,WIZ_RESET);		     //WIZ_RESET  高电平
  Delay_MS(1000);
}
